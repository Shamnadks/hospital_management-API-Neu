...
export class update_doctor_service {
  ...
  private constructor(
    ...
    this.serviceName = 'update_doctor_service';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new update_doctor_service(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_update_doctor_service_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: update_doctor_service');
    //appendnew_flow_update_doctor_service_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: update_doctor_service');
    //appendnew_flow_update_doctor_service_HttpIn
  }
  ...
  async errorHandle(bh, parentSpanInst) {
    const catchConnectedNodes = ['sd_RYNgEiNthZIEzWDV'];
  ...
  //appendnew_flow_update_doctor_service_Catch
}
